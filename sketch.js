...
function setup() {
	...
	rope1=new rope(bob1.body,roofObject.body,-20)
	rope2=new rope(bob2.body,roofObject.body,-10)
	rope3=new rope(bob3.body,roofObject.body,20)
	rope4=new rope(bob4.body,roofObject.body,20)
	rope5=new rope(bob5.body,roofObject.body,20)
